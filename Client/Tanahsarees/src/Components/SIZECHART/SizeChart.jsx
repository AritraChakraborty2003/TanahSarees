...
const SizeChart = () => {
  ...
  return (
    <div
      className="flex flex-col justify-center items-center gap-15 lg:gap-30 w-full  lg:mt-[10vh] mb-10 pl-10 pr-10 lg:pl-[50vh] lg:pr-[50vh]"
      style={{
        marginTop: `${
          !change
            ? screen.width > 1000
    ...
    >
      ...
      <div className="w-[50vw] lg:w-[70vw] lg:h-70vh  shadow-2xl">
