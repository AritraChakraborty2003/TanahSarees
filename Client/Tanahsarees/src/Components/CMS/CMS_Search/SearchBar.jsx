...
const SearchBar = (props) => {
  ...
  return (
    <div className="w-[100%] border-[0.15px] flex justify-center items-center  border-2 border-gray-300 bg-white pl-1 pr-1">
      <div className="inputHolder w-[100%] p-2 flex">
        <input
          type="text"
          placeholder={`Enter Product ${categoryMap[category]}`}
          className="inputField w-[90%]  rounded-md darktext font-Montserrat font-medium p-2 text-sm lg:text-md"
        />
        <button className="searchBtn  w-[11vmin]  lg:w-[10vmin] rounded-md darktext font-Montserrat font-medium">
