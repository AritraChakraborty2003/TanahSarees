...
const SliderComponent = () => {
  const { change, filterItem, setFilterItem } = useContext(AppContext);
      ...
      {sareeData.length > 0 ? (
        <>
          <button
            ...
            className="hidden lg:block  absolute left-1 lg:left-2 top-[40%] lg:top-[10%] transform -translate-y-1/2 z-10 p-1 lg:p-3 rounded-full"
          >
          ...
          <button
            ...
            className="hidden lg:block absolute right-1 lg:right-4 top-[40%]  lg:top-[10%] transform -translate-y-1/2 z-10 p-1 lg:p-3 rounded-full"
          >
