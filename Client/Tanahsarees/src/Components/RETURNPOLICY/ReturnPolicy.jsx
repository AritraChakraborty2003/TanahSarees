...
const ReturnPolicy = () => {
  ...
  return (
    <>
      ...
      {/* > */}
      <div className="w-[95vw] pl-8 pr-4 pb-8">
        <p className="text-sm mt-8">
          <span className="text-4xl font-bold">Return Policy</span>
          <br></br>
          <br></br> We offer refund / exchange within first 7 days from the date
          of your purchase. If 7 days have passed since your purchase, you will
          not be offered a return, exchange or refund of any kind. In order to
          ...
          notify you about receipt of the returned / exchanged product.
