      ...
      <div className="flex flex-wrap pb-4 justify-center items-center overflow-hidden cursor-pointer gap-x-4 gap-y-6 lg:gap-x-17 lg:gap-y-10 2xl:gap-y-3">
        {data.map((item) => (
          <div className="overflow-hidden ">
            ...
            <h2 className=" w-[45vw] mt-1  lg:w-64 h-20 lg:h-30 font-Montserrat text-center pr-1 pl-1 bottom-5 lg:bottom-10 text-[3vmin] lg:text-[1.65vmin] 2xl:text-[1.95vmin] font-light flex pt-1 justify-center   overflow-hidden">
